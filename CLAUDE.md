...
- **Gestión de planes desde "Usuario"** — **EN ALTO OBLIGATORIO, sin tocar.** Contradice `04-PANEL-ADMIN-SUSCRIPCIONES.md`: hoy Suscripciones administra el **catálogo** de los 3 planes, y el único sitio donde se cambia el plan **de una cuenta concreta** es Admin → Usuarios. Quitarlo sin construir el reemplazo dejaría el producto sin ningún punto para hacerlo. 3 preguntas abiertas al propietario en el archivo de tarea.
