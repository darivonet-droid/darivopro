...
- **Pendiente**: verificación **en vivo** (login del Gerente, crear/asignar rol) — el código está en `develop`, **sin mergear a `main`** (no se mergea sin aviso). Detalle: `docs-internos/tareas/2026-07-23-fase2-roles-personalizados-enforcement.md`.
