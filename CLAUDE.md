...
- Empresa — 9/9 pantallas auditadas MD↔código y verificadas visualmente, 9/9 migradas a `ADMIN_COLORS` (shell + contenido). Los 5 componentes compartidos con Móvil que quedaron en azul (`ClienteFichaView.tsx`, `MasTabs.tsx`, `MasOpcionesList.tsx`, `IACotizacionFlow.tsx`, `InformesTab.tsx`) se corrigieron 22/07/2026 con el patrón `esEmpresa` (prop booleana, gateo condicional del color) — Móvil sigue con el azul de Fable 5 sin ningún cambio, confirmado por código en cada punto de entrada. Detalle: `docs-internos/tareas/2026-07-22-verificacion-admin-colors-empresa.md`.
...
- [2026-07-22-verificacion-admin-colors-empresa.md](docs-internos/tareas/2026-07-22-verificacion-admin-colors-empresa.md) — cerrada. Corrigió "Empresa 9/9 migradas a ADMIN_COLORS" (eran 5/9) y luego migró los 5 componentes compartidos con Móvil que faltaban (`ClienteFichaView`, `MasTabs`, `MasOpcionesList`, `IACotizacionFlow`, `InformesTab`) con el patrón `esEmpresa`, sin tocar Móvil. Ahora sí 9/9.
