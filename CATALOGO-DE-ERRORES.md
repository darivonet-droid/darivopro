...
**Versión:** 1.1 · **Creado:** 14/07/2026

**Cambio v1.1 (16/07/2026):** `INC-A01`/`INC-M01`/`INC-B01` retirados — DOC-01 resuelto (backend real de tickets construido, ver `05-FRONTEND-DARIVO-PRO.md` v2.3). Esos 3 códigos ya no aparecen en ninguna pantalla.

Catálogo de los códigos que se muestran en la app en vez de un mensaje crudo o un crash. Cuando aparezca un código en pantalla (`ERR-004`, `PEND-001`), esta tabla dice qué es, si ya se conoce, y qué hacer.
...
- Los códigos `INC-A01`, `INC-M01`, `INC-B01` que antes vivían acá (definidos en [`05-FRONTEND-DARIVO-PRO.md` §7](.cursor/rules/05-FRONTEND-DARIVO-PRO.md)) quedaron resueltos el 16/07/2026 (DOC-01) y se retiraron de `error-catalog.ts` — ya no hay ninguna pantalla que los muestre.
...
Ninguno activo actualmente — `INC-A01`/`INC-M01`/`INC-B01` (soporte) quedaron resueltos el 16/07/2026, ver changelog arriba.
