...
Contacto para temas de privacidad: [email de contacto específico, ej. privacidad@darivopro.com]
...
* Comunicarnos contigo (soporte, avisos importantes del servicio).
...
|---|---|---|
| Supabase | Base de datos y autenticación | Alojamiento en la nube (confirmar región del centro de datos) |
| Vercel | Alojamiento de la aplicación web | Alojamiento en la nube |
| OpenAI | Funcionalidades de inteligencia artificial (asistente de cotizaciones/soporte) | Procesamiento de las consultas que envías al asistente de IA |
| [dLocal / proveedor de pago real] | Procesamiento de pagos de suscripción | — |
| [Proveedor OSE de facturación electrónica, cuando se confirme] | Emisión de comprobantes electrónicos certificados | Perú |

**No vendemos tus datos a terceros con fines publicitarios.**

*(⚠️ Punto que requiere confirmación legal: si alguno de estos proveedores transfiere datos fuera de la UE/España — por ejemplo, servidores en EE.UU. — puede requerir cláusulas contractuales tipo (SCC) u otra base legal de transferencia internacional bajo RGPD. Confirmar con abogado y revisar los propios términos de cada proveedor.)*
...
Aplicamos medidas técnicas razonables para proteger tus datos (cifrado en tránsito, control de acceso, copias de seguridad). Ningún sistema es 100% invulnerable; te recomendamos usar una contraseña robusta y no compartirla.

## 8. Cookies

Darivo Pro utiliza cookies técnicas necesarias para el funcionamiento del servicio (mantener tu sesión iniciada). [Pendiente: confirmar si se usan cookies de analítica/marketing (ej. Google Analytics, Meta Pixel) — si es así, se necesita un banner de consentimiento de cookies conforme a la normativa de cada país antes de publicar.]
...
* [Pendiente: requisitos específicos de la Ley N.º 29733 (Ley de Protección de Datos Personales del Perú) y su reglamento — inscripción de bancos de datos ante la autoridad peruana si aplica, confirmar con asesor legal peruano.]
