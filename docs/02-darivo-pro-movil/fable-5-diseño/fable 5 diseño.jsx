...
function SettingsScreen({activeCats,setActiveCats,prices,setPrices,catalog,customServices,setCustomServices,onToast,bizData,setBizData}){
  ...
  return (
    <div style={{paddingBottom:90}}>
      <DarkHeader>
        <h2 style={{color:T.white,fontSize:20,fontWeight:900,marginBottom:4}}>Configuración</h2>
        <p style={{color:T.textLight,fontSize:13}}>Capítulos · partidas · tarifas</p>
      </DarkHeader>
      ...
      <div style={{padding:"16px 16px 0"}}>
        <div style={{display:"flex",background:T.slateD,borderRadius:14,padding:4,marginBottom:18}}>
          {[["cats","Capítulos"],["prices","Mis Tarifas"],["biz","Empresa"]].map(([k,l])=>(
