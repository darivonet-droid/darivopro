...
| ----- | -------------------- |
| WhatsApp | Wizard cotización confirmación post-Cliente (`05-MODULO-COTIZACIONES.md` § Paso 4) · `PDFModal` / `InvoiceModal` (`06-MODULO-FACTURAS.md` §6) |
| Compartir (WhatsApp, Telegram, Email, etc.) | `PDFModal` — Web Share API (`05-MODULO-COTIZACIONES.md` § Paso 4 confirmación) |
| Descargar PDF | `InvoiceModal` (`06-MODULO-FACTURAS.md` §6) |
| Generación automática | Al guardar definitivo (Paso 4), PDF en segundo plano |
...
| Datos del cliente | `05-MODULO-COTIZACIONES.md` § Paso 4 |
...
| Numeración COT- | `05-MODULO-COTIZACIONES.md` § Paso 4 confirmación · Regla 10 |
...
| Número COT-XXX | Confirmación Paso 4 (`05-MODULO-COTIZACIONES.md` · Regla 10) |
| Fecha | Fecha de guardado definitivo (Paso 4) |

#### Bloque Cliente

Datos del **Paso 4 — Cliente** del wizard (`05-MODULO-COTIZACIONES.md`):
...
- Resumen del wizard: **tabla agrupada por categoría con sus partidas y subtotales**, orden Catálogo Maestro (`05-MODULO-COTIZACIONES.md` § Paso 3 · Regla 9).
...
| Cant | Medición capturada en Cantidades según tipo de cálculo de la partida (`05` §4 Reglas 4–9) |
...
Los estados internos de cotización (**Borrador**, **Pendiente**, **Aprobado**) se asignan en el Resumen del wizard (Paso 3 — `05-MODULO-COTIZACIONES.md`); el guardado definitivo ocurre en Paso 4.
...
- Define el flujo de creación (Selección → Cantidades → Resumen → Cliente → Guardar) del que provienen los datos del PDF de cotización.
