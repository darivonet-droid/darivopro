"use client";
// DARIVO PRO — Mis Tarifas (extraído de MasTabs.tsx el 22/07/2026 para
// reutilizarlo también en Darivo Pro Empresa, "Catálogo · Mis Tarifas"
// (07-MODULO-MAS-EMPRESA.md §5.1) — Móvil sigue usándolo sin cambios dentro
// de MasTabs.tsx, mismo componente, mismo comportamiento.
...
export function MisTarifasTab({ esEmpresa }: { esEmpresa?: boolean }) {
